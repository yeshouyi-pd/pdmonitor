...
import com.pd.monitor.netsdk.lib.structure.DEV_EVENT_NUMBERSTAT_INFO;
...
public enum EM_EVENT_IVS_TYPE {
    ...
    /**
     * {@link com.pd.monitor.netsdk.lib.structure.DEV_EVENT_TRAFFIC_PEDESTRAINRUNREDLIGHT_INFO}
     */
    ...
    /**
     * {@link com.pd.monitor.netsdk.lib.structure.DEV_EVENT_SHOP_WINDOW_POST_INFO}
     */

    EVENT_IVS_SHOP_WINDOW_POST(0x00000287, "橱窗张贴事件"),
    /**
     * (对应 DEV_EVENT_SHOP_SIGN_ABNORMAL_INFO)
     * {@link com.pd.monitor.netsdk.lib.structure.DEV_EVENT_SHOP_SIGN_ABNORMAL_INFO}
     */
