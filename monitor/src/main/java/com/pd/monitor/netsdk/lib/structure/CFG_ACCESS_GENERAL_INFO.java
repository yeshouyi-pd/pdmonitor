...
import static com.pd.monitor.netsdk.lib.constant.SDKStructureFieldLenth.MAX_ADDRESS_LEN;
import static com.pd.monitor.netsdk.lib.constant.SDKStructureFieldLenth.MAX_PASSWORD_LEN;
...
public class CFG_ACCESS_GENERAL_INFO extends NetSDKLib.SdkStructure {
  ...
  /** 门禁通道单双向配置,对应枚举{@link com.pd.monitor.netsdk.lib.enumeration.CFG_ACCESS_PROPERTY_TYPE} */
