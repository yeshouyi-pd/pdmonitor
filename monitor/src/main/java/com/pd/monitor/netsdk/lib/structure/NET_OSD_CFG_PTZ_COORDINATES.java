...
import com.pd.monitor.netsdk.lib.enumeration.NET_EM_CFG_OPERATE_TYPE;

/**
 * 显示云台坐标的叠加配置
 * {@link NET_EM_CFG_OPERATE_TYPE#NET_EM_CFG_PTZ_COORDINATES}
 *
 * @author 47040
 * @version 1.0.0
 * @since Created in 2021/3/8 20:39
 */
public class NET_OSD_CFG_PTZ_COORDINATES extends NetSDKLib.SdkStructure {
    ...
    public NET_OSD_CFG_PTZ_COORDINATES() {
        dwSize = this.size();
    }
