...
import com.pd.monitor.netsdk.lib.enumeration.EM_CAPTURE_PROCESS_END_TYPE;
import com.pd.monitor.netsdk.lib.enumeration.EM_TRIGGER_TYPE;

/**
 * 事件类型 EVENT_IVS_CAR_DRIVING_OUT(车辆驶出事件)对应的数据块描述信息
 *
 * @author ： 47040
 * @since ： Created in 2020/8/20 11:30
 */
public class DEV_EVENT_CAR_DRIVING_OUT_INFO extends NetSDKLib.SdkStructure {
    /**
     * 通道号
     */
