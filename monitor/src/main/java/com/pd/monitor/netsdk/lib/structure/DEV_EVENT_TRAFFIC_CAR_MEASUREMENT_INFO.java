...
public			int					nSpeed;
/** 
触发类型 {@link com.pd.monitor.netsdk.lib.enumeration.EM_TRIGGER_TYPE}
*/
public			int					emTriggerType;
/** 
触发时机 {@link com.pd.monitor.netsdk.lib.enumeration.EM_TRIGGER_OCCUR_TYPE}
*/
...
/** 
抓拍过程 {@link com.pd.monitor.netsdk.lib.enumeration.EM_CAPTURE_PROCESS_END_TYPE}
*/
...
/** 
车辆行驶方向(相对车道方向) {@link com.pd.monitor.netsdk.lib.enumeration.EM_VEHICLE_DRIVING_DIRECTION}
*/
public			int					emDrivingDirection;
/** 
交通信号灯类型 {@link com.pd.monitor.netsdk.lib.enumeration.EM_TRFAFFIC_LIGHT_TYPE}
*/
