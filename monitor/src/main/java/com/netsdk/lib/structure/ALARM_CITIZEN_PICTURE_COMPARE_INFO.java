...
public class ALARM_CITIZEN_PICTURE_COMPARE_INFO extends SdkStructure {
     ...
     * 事件发生的时间
     */
    public NetSDKLib.NET_TIME_EX stuTime;
    /**
     ...
     * 出生日期(年月日)
     */
    public NetSDKLib.NET_TIME stuBirth;
    /**
     * 有效期限起始日期(年月日)
     */
    public NetSDKLib.NET_TIME stuValidityStart;
    /**
     ...
     */
    public NetSDKLib.NET_TIME stuValidityEnd;
    /**
     * IC卡号
     */
