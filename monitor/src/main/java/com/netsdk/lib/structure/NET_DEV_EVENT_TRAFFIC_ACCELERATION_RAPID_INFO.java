...
/** 
* @author 291189
* @description  事件类型 EVENT_IVS_TRAFFIC_ACCELERATION_RAPID (急加速事件)对应的数据块描述信息 
* @origin autoTool
* @date 2023/02/14 20:19:38
*/
public class NET_DEV_EVENT_TRAFFIC_ACCELERATION_RAPID_INFO extends NetSDKLib.SdkStructure {
/** 
通道号
*/
...
/** 
事件类型掩码, bit0表示报警事件, bit1表示违章事件, 若bit0和bit1都置位则既是报警事件又是违章事件
*/
...
public NET_DEV_EVENT_TRAFFIC_ACCELERATION_RAPID_INFO(){
}
}