...
public class FACERECOGNITION_PERSON_INFOEX extends SdkStructure {
  ...
  /** 注册人员信息扩展 */
  public NetSDKLib.CUSTOM_PERSON_INFO[] szCustomPersonInfo =
      new NetSDKLib.CUSTOM_PERSON_INFO[NET_MAX_CUSTOM_PERSON_INFO_NUM];
  /** 注册库类型,对应{@link EM_REGISTER_DB_TYPE} */
  public int emRegisterDbType;
  /** 有效期时间 */
  public NetSDKLib.NET_TIME stuEffectiveTime;
