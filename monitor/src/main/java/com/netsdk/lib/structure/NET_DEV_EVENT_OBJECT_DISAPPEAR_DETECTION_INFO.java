...
/**
 * @author 260611
 * @description 事件类型 EVENT_IVS_OBJECT_DISAPPEAR_DETECTION (目标出现事件)对应的数据块描述信息
 * @date 2023/04/21 16:10:02
 */
public class NET_DEV_EVENT_OBJECT_DISAPPEAR_DETECTION_INFO extends NetSDKLib.SdkStructure {
    /**
     * 通道号
     */
    ...
    public NET_DEV_EVENT_OBJECT_DISAPPEAR_DETECTION_INFO() {
