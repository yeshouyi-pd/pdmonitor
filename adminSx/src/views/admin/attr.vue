            ...
            <table  style="font-size: 1.1em;" class="text-right  " >
              ...
              <tr  >
                ...
                <td style="width: 20%">
                  ...
                  &nbsp;&nbsp;&nbsp;
                  <button type="button" @click="resetQuery" class="btn btn-sm btn-success btn-round">
  ...
  export default {
    ...
    methods: {
      ...
      save() {
        ...
        // 保存校验
        if (!Validator.require(_this.attr.attrcode, "属性代码")
        ...
        Confirm.show("删除属性设置后不可恢复，确认删除？", function () {
          ...
          _this.$ajax.delete(process.env.VUE_APP_SERVER + '/system/admin/attr/delete/' + id).then((response) => {
            ...
            if (resp.success) {
              ...
              Toast.warning(resp.message || "删除失败");
            }
          }).catch(() => {
            Loading.hide();
            Toast.warning("删除失败");
