            ...
            <form>
              <table style="font-size: 1.1em;width:80%" class="text-right" >
                ...
                <tr>
                  ...
                  <td style="width: 35%;">
                    <time-range-picker v-bind:startTime="startTime" v-bind:endTime="endTime" v-bind:svalue="alarmNumbersDto2.stime" v-bind:evalue="alarmNumbersDto2.etime"></time-range-picker>
                  </td>
                  <td colspan="2" class="text-center">
                    <button type="button" v-on:click="getChangeHourData()" class="btn btn-sm btn-info btn-round" style="margin-right: 10px;">
  ...
  methods: {
    ...
    zTreeOnClick(event, treeId, treeNode){
      ...
      if(treeNode.type=='2'){
        ...
        _this.getOneHourData();
        _this.getEightHourData();
        _this.getChangeHourData();
      }
    },
    getOneHourData(){
      let _this = this;
      Loading.show();
      _this.alarmNumbersDto.stime=Tool.dateFormat("yyyy-MM-dd hh:mm",new Date(_this.curDate.getTime()-3600000));
    ...
    getEightHourData(){
      let _this = this;
      Loading.show();
      _this.alarmNumbersDto1.stime=Tool.dateFormat("yyyy-MM-dd hh:mm",new Date(_this.curDate.getTime()-3600000*8));
