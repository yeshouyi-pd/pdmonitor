<template>
    <div :style="'height: '+maxHeight+'px'">
      <div v-if="!isMobileflag" class="main-content" style="width: 100%;height: 100vh;background-image: url('/static/image/loginbgsx.jpg');background-size: 100% 100%;">
        ...
        <div style="margin-top: 10%;text-align: center">
          <img height="40px;" src="/largemonitors/assets/imgs/tx.png">
          <div style="font-size: 18px;">长江生态环境工程研究中心</div>
          <div style="font-size: 18px;">三峡新能源阳江发电有限公司</div>
        </div>
      </div>
