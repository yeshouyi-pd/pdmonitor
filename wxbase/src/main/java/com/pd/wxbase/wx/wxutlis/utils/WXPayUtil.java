...
public class WXPayUtil {
    ...
    public static String generateSignedXml(final Map<String, String> data, String key) throws Exception {
        return generateSignedXml(data, key, WeixinUtil.MD5);
    }
    ...
    public static String generateSignedXml(final Map<String, String> data, String key, String signType) throws Exception {
        ...
        data.put(WeixinUtil.FIELD_SIGN, sign);
    ...
    public static boolean isSignatureValid(String xmlStr, String key) throws Exception {
        ...
        if (!data.containsKey(WeixinUtil.FIELD_SIGN) ) {
            return false;
        }
        String sign = data.get(WeixinUtil.FIELD_SIGN);
    ...
    public static boolean isSignatureValid(Map<String, String> data, String key) throws Exception {
        return isSignatureValid(data, key, WeixinUtil.MD5);
    }
    ...
    public static String generateSignature(final Map<String, String> data, String key) throws Exception {
        return generateSignature(data, key, WeixinUtil.MD5);
    }
    ...
    public static String generateSignature(final Map<String, String> data, String key, String signType) throws Exception {
        ...
        for (String k : keyArray) {
            if (k.equals(WeixinUtil.FIELD_SIGN)) {
                continue;
            }
