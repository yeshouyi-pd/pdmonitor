<template>
  <div class="video-player">
    ...
    <video
        ...
        preload="auto"
        muted="true"
        src="/static/wx/wfzxjy/example.mp4"
    ...
    >
      ...
      <div class="play" @touchstart.stop="clickPlayBtn" v-show="state.controlBtnShow">
        <img
            ...
            src="/static/wx/wfzxjy/content_btn_play.svg"
        >
        <img
            v-show="state.playing  && !state.isLoading"
            src="/static/wx/wfzxjy/content_btn_pause.svg"
        >
      ...
      <div class="control-bar" :style="{ visibility: state.controlBarShow ? 'visible' : 'hidden'}">
        ...
        <span class="progress" ref="progress">
          <img
              ...
              src="/static/wx/wfzxjy/content_ic_tutu.svg"
          >
        ...
        <span class="full-screen" @click="fullScreen">
          <img src="/static/wx/wfzxjy/video/content_ic_increase.svg" alt>
        </span>
      </div>
    </div>
    <!-- 错误弹窗 -->
...
export default {
  ...
  methods: {
    ...
    clickPlayBtn() {
      ...
      if(this.isFirstTouch&&this.$parent.startPlay()){
        this.$parent.startPlay();
      }
