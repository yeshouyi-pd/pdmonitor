...
export default {
  ...
  methods: {
    ...
    getPlayUrl(item){
      ...
      // let item = {
      //   'sbbh':'tl002',
      //   'wjlj':'http://111.38.20.175:7003/tempData/tl002/2023_12_19_19_16_47_2023_12_19_19_17_47_0_A1_TD2.mp4'
      // }
      $("#playbox").empty();
      Loading.show();
      let url = 'http://111.38.20.175:7003/FileInfo.asmx/GetPlayUrl';
