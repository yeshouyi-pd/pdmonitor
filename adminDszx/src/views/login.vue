<template>
    <div :style="'height: '+maxHeight+'px'">
      <div v-if="!isMobileflag" class="main-content" style="padding: 0px;width: 100%;height: 100vh;background-image: url('/static/image/loginbg.jpg');background-size: 100% 100%;">
        ...
        <div v-if="LOCAL_SSBRL || LOCAL_TLBHQ" class="center" style="margin-top: 5%;margin-bottom: 5.5%">
          <span :style="'font-size:'+fontsize+'px;margin-left:30%;'">
            <img :style="'height:'+imgsize+'px;margin-top: -8px;margin-right:10px;'" src="/static/RPCD13.png"/>
        ...
        <div style="position: absolute;bottom: 30px;font-size: 20px;color: #999;width: 100%;text-align: center;">中国水产科学研究院淡水渔业研究中心</div>
      </div>
