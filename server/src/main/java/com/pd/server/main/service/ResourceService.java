...
import com.pd.server.main.mapper.ResourceMapper;
import com.pd.server.main.mapper.my.MyResourceMapper;
...
public class ResourceService {
     ...
     * @return
     */
    public List<ResourceDto> selectAll(UserDto userDto){
        List<Resource> resourceList = new ArrayList<Resource>();
        if(null != userDto){
            if(!StringUtils.isEmpty(userDto.getRode())){
                resourceList =   myResourceMapper.selectAll(userDto.getRode());
            }
        }
    ...
    public List<String> getUpRescode(String id){
        String ids = myResourceMapper.getUpRescode(id);
        List<String> rescodelist = new ArrayList<String>();
        if(!StringUtils.isEmpty(ids)){
            rescodelist =  Arrays.asList(ids.replaceAll(" ", "").split(","));
        }
            return rescodelist;
    }
    ...
    public List<ResourceDto> selectexample(ResourceExample example){
        List<Resource> resourceList = resourceMapper.selectByExample(example);
        List<ResourceDto> resourceDtoList = CopyUtil.copyList(resourceList, ResourceDto.class);
        return resourceDtoList;
