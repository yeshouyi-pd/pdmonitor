...
public class DesEncrypt {
    ...
    private final static String defaultKey = "11111111";//秘钥

    public static void main(String[] args) throws Exception {
        String data = "420881199010145155";
     ...
     * @return
     */
    public static String DesJiaMi(String data) throws Exception {
        return encrypt(data);
    }
     ...
     * @return
     */
    public static String DesJieMi(String data) throws Exception {
        return decrypt(data);
    }
