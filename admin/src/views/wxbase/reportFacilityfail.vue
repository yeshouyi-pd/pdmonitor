  ...
  <div>
      ...
      <div class="col-md-12">
        ...
        <div class="widget-box">
          <div class="widget-header">
            <h4 class="widget-title">交安故障上报查询</h4>
              ...
              <form >
                <table  style="font-size: 1.1em;width: 100%" class="text-right">
                  ...
                  <tr  >
                    ...
                    <td style="width: 8%">
                      <select v-model="reportFacilityfailDto.zt" class="form-control" id="form-field-select-1">
                        <option value="" selected>请选择</option>
    ...
    <table id="simple-table" class="table  table-bordered table-hover">
      ...
      <tr v-for="reportFacilityfail in reportFacilityfails">
              ...
              <td>{{maps|optionMapKV(reportFacilityfail.sysOrgCode)}}</td>
              ...
              <td>{{ usersMap|optionMapKV(reportFacilityfail.shr) }}</td>
              <td>{{reportFacilityfail.shsj}}</td>
        ...
        <td>
          <div class="hidden-sm hidden-xs btn-group">
            <button v-on:click="edit(reportFacilityfail)" class="btn btn-xs btn-info2" title="详情">
            ...
            <form class="form-horizontal">
              <div class="profile-user-info profile-user-info-striped">
                <div class="profile-info-row">
                  ...
                  <div class="profile-info-value" style="width: 40%">
                    <span class="editable" id="gzlx">{{gzlx|optionMapKV(reportFacilityfail.gzlx)}}</span>
                  </div>
                </div>
                ...
                <div class="profile-info-row">
                  ...
                  <div class="profile-info-name"  style="width: 10%">处理部门</div>
                  <div class="profile-info-value" style="width: 40%">
                    <span class="editable" >{{maps|optionMapKV(reportFacilityfail.sysOrgCode)}}</span>
                  </div>
                </div>
                ...
                <div class="profile-info-row">
                  ...
                  <div class="profile-info-value">
                    <span class="editable" id="shr"> {{ usersMap|optionMapKV(reportFacilityfail.shr) }}</span>
                  </div>
                  <div class="profile-info-name"  >处理时间</div>
                  <div class="profile-info-value" >
                    <span class="editable" id="shsj">{{reportFacilityfail.shsj}}</span>
                  </div>
                </div>
                ...
                <div class="profile-info-row">
                  ...
                  <div class="profile-info-value">
                    <span class="editable" id="zt"><span v-if="reportFacilityfail.zt =='1'">已上报</span><span v-else-if="reportFacilityfail.zt =='2'">已处理</span><span v-else-if="reportFacilityfail.zt =='3'">虚假上报</span></span>
                  </div>
                  <div class="profile-info-name"  >处理意见说明</div>
                  <div class="profile-info-value" >
                    <span class="editable" id="clyj">{{reportFacilityfail.clyj}}</span>
                  </div>
                </div>
              </div>
