      ...
      <div class="col-md-12">
        ...
        <div class="widget-box">
          <div class="widget-header">
            <h4 class="widget-title">渍水上报处理</h4>
      ...
      <tr v-for="reportWater in reportWaters">
        ...
        <td>
          <div class="hidden-sm hidden-xs btn-group">
            <button v-on:click="edit(reportWater)" class="btn btn-xs btn-info" title="处理">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="radio">
                    ...
                    <label>
                      <input name="form-field-radio" type="radio" class="ace"  value="3" v-model="zt"/>
                      <span class="lbl">虚假上报</span>
                    </label>
                  </div>
                </div>
              </div>
              <div class="form-group" v-if="zt=='3'">
                <label class="col-sm-2 control-label">处理反馈</label>
                <div class="col-sm-8">
                  <input v-model="reportWater.clfk" class="form-control">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">备注</label>
                <div class="col-sm-8">
                  <input v-model="reportWater.bz" class="form-control">
                </div>
              </div>
...
export default {
  ...
  mounted: function () {
      ...
      _this.list(1);
      // sidebar激活样式方法一
      // this.$parent.activeSidebar("wxbase-reportWater-sidebar");
    ...
    methods: {
      ...
      save() {
        ...
        if(_this.zt=='3'){
          if(!Validator.require(_this.reportWater.clyj, "处理反馈")){
            return;
          }
        }
        _this.reportWater.zt = _this.zt;
        Loading.show();
