      ...
      <div class="col-md-12">
        ...
        <div class="widget-box">
          <div class="widget-header">
            <h4 class="widget-title">驾驶人取消考试查询</h4>
              ...
              <form >
                <table  style="font-size: 1.1em;width: 100%" class="text-right">
                  ...
                  <tr  >
                    ...
                    <td style="width: 8%">
                      <select v-model="drvQxksDto.zt" class="form-control" id="form-field-select-1">
      ...
      <tr v-for="drvQxks in drvQxkss">
        ...
        <td>
          <div class="hidden-sm hidden-xs btn-group">
            <button v-on:click="check(drvQxks)" class="btn btn-xs btn-info" title="详情">
          ...
          <div class="modal-body">
            <form class="form-horizontal">
              ...
              <div class="profile-user-info profile-user-info-striped">
                ...
                <div class="profile-info-row">
                  <div class="profile-info-name" style="width: 10%;height: 30px">审核人</div>
                  <div class="profile-info-value"  style="width: 40%">
                    <span class="editable" >{{usersMap|optionMapKV(drvQxks.shr)}}</span>
                  </div>
                  <div class="profile-info-name" style="width: 10%;height: 30px">审核日期</div>
                  <div class="profile-info-value"  style="width: 40%">
                    <span class="editable" >{{drvQxks.shsj}}</span>
                  </div>
                ...
                <div class="profile-info-row">
                  <div class="profile-info-name" style="width: 10%;height: 30px">状态</div>
                  <div class="profile-info-value"  style="width: 40%">
                    <span class="editable" ><span v-if="drvQxks.zt =='1'">已申请</span><span v-if="drvQxks.zt =='2'">审核通过</span><span v-else-if="drvQxks.zt =='3'">审核不通过</span></span>
                  </div>
                  <div class="profile-info-name" style="width: 10%;height: 30px">审核说明</div>
                  <div class="profile-info-value"  style="width: 40%">
                    <span class="editable" >{{drvQxks.shsm}}</span>
                  </div>
                </div>
                ...
                <div class="profile-info-row">
                  ...
                  <div class="profile-info-value"  style="width: 40%">
                    <span class="editable" >{{drvQxks.bz}}</span>
                  </div>
                  <div class="profile-info-name" style="width: 10%;height: 30px">&nbsp;</div>
                  <div class="profile-info-value"  style="width: 40%">
                    &nbsp;
                  </div>
                </div>
    ...
    methods: {
      ...
      save() {
        ...
        if (1 != 1
                ...
                || !Validator.length(_this.drvQxks.sfzmhm, "身份证明号码", 1, 20)
