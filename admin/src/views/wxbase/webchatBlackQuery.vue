  ...
  <div>
              ...
              <form >
                <table  style="font-size: 1.1em;" class="text-right" >
                  ...
                  <tr  >
                    ...
                    <td style="width: 10%">
                      <select v-model="webchatBlackDto.zt" class="form-control" id="form-field-select-1">
                        <option value="" selected>请选择</option>
                        <option value="1">黑名单中</option>
    ...
    <table id="simple-table" class="table  table-bordered table-hover">
      ...
      <tr v-for="webchatBlack in webchatBlacks">
              ...
              <td>{{usersMap|optionMapKV(webchatBlack.updateBy)}}</td>
        ...
        <td>
          <div class="hidden-sm hidden-xs btn-group">
            <button v-on:click="edit(webchatBlack)" class="btn btn-xs btn-info" title="查看">
      ...
      <div class="modal-dialog" role="document" style="width:60%">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">黑名单详细信息</h4>
          </div>
            ...
            <form class="form-horizontal">
              <div class="profile-user-info profile-user-info-striped">
                ...
                <div class="profile-info-row">
                  ...
                  <div class="profile-info-value">
                    <span class="editable" id="sysOrgCode">{{maps|optionMapKV(webchatBlack.sysOrgCode)}}</span>
                  </div>
                  <div class="profile-info-name">处理人</div>
                  <div class="profile-info-value">
                    <span class="editable" id="updateBy">{{usersMap|optionMapKV(webchatBlack.updateBy)}}</span>
                  </div>
                </div>
                ...
                <div class="profile-info-row">
                  ...
                  <div class="profile-info-value">
                    <span class="editable" id="updateTime">{{webchatBlack.updateTime}}</span>
                  </div>
                  <div class="profile-info-name">处理备注</div>
                  <div class="profile-info-value">
                    <span class="editable" id="bz">{{webchatBlack.bz}}</span>
                  </div>
                </div>
              </div>
