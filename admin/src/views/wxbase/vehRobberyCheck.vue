      ...
      <div class="col-md-12">
        ...
        <div class="widget-box">
          <div class="widget-header">
            <h4 class="widget-title">套牌车报案受理</h4>
        ...
        <tr v-for="vehRobbery in vehRobberys">
          ...
          <td>
            <div class="hidden-sm hidden-xs btn-group">
              <button v-on:click="edit(vehRobbery)" class="btn btn-xs btn-info" title="受理">
...
<!--                  <div class="profile-info-value">-->
<!--                    <span class="editable" id="sysOrgCode">{{maps|optionMapKV(vehRobbery.sysOrgCode)}}{{vehRobbery.sysOrgCode}}</span>-->
<!--                  </div>-->
...
<!--                </div>-->
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="radio">
                    <label>
                      <input name="form-field-radio" type="radio" class="ace"  value="2" v-model="vehRobbery.zt"/>
                      <span class="lbl">已受理</span>
                    </label>
                    <label>
                      <input name="form-field-radio" type="radio" class="ace"  value="3" v-model="vehRobbery.zt"/>
                      <span class="lbl">无法受理</span>
                    </label>
                  </div>
                </div>
              </div>

              <div class="form-group" v-if="vehRobbery.zt=='3'">
                <label class="col-sm-2 control-label">审核说明</label>
                <div class="col-sm-8">
                  <input v-model="vehRobbery.shsm" class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input v-model="vehRobbery.bz" class="form-control">
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    save() {
      let _this = this;
      if(_this.vehRobbery.zt=='3'){
        if(!Validator.require(_this.vehRobbery.shsm, "审核说明")){
          return;
        }
      }
      // 保存校验
