      ...
      <div class="col-md-12">
        ...
        <div class="widget-box">
          <div class="widget-header">
            <h4 class="widget-title">车牌螺丝固封申领线下处理</h4>
          ...
          <div class="modal-body">
            <form class="form-horizontal">
              ...
              <span v-if="slcs > 3">
                  ...
                  <label class=" control-label" style="color: red">该车已累计申领车牌固封螺丝{{slcs}}次,工作人员请仔细核对信息！</label>
                  <input v-model="slcs" type="hidden">
              </span>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="radio">
                    <label>
                      <input name="form-field-radio" type="radio" class="ace"  value="3" v-model="vehScrew.zt" />
                      <span class="lbl">可以申领</span>
                    </label>
                    <label>
              ...
              <div class="form-group" v-if="vehScrew.zt=='4'">
...
export default {
  ...
  methods: {
    ...
    list(page) {
      ...
      _this.$forceUpdate();
      _this.$ajax.post(process.env.VUE_APP_SERVER + '/wxbase/admin/vehScrew/vehScrewScene', _this.vehScrewDto ).then((response)=>{
        Loading.hide();
        let resp = response.data;
