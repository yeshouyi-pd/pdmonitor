...
<!--        <td>{{ vehParkLot.ccms }}</td>-->
        ...
        <td>
          <div class="hidden-sm hidden-xs btn-group">
            <button v-on:click="edit(vehParkLot)" class="btn btn-xs btn-info" title="出场">
...
<!--                </div>-->
    ...
    <div id="form-modal-out" class="modal fade" tabindex="-1" role="dialog">
...
<!--                  </select>-->
                  <div class="radio">
                    <label>
                      <input name="form-field-radio" type="radio" class="ace"  value="3" v-model="vehParkLot.ccyy"/>
                      <span class="lbl">缴纳罚款</span>
                    </label>
                    <label>
                      <input name="form-field-radio" type="radio" class="ace"  value="4" v-model="vehParkLot.ccyy"/>
                      <span class="lbl">满分学习</span>
                    </label>
                  </div>
                </div>
              </div>
  ...
  export default {
    ...
    methods: {
      ...
      edit(vehParkLot) {
        ...
        _this.vehParkLot.ccyy = "3";
        _this.$forceUpdate();
        $("#form-modal-out").modal("show");
      },
