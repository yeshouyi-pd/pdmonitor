...
@Component
public class WaterDataAvgController {
    public static WaterQualityResultMapper waterQualityResultStaticMapper;

    public static WaterQualityAvgMapper waterQualityAvgStaticMapper;
    ...
    @PostConstruct
    protected void init() {
        waterQualityResultStaticMapper = waterQualityResultMapper;
        waterQualityAvgStaticMapper = waterQualityAvgMapper;
    }
    ...
    public static void waterDataAvgSchedule(){
        ...
        for(WaterQualityAvgDto dto : list){
            ...
            entity.setCreateTime(DateUtil.toDate(DateUtil.getFormatDate(new Date(),"yyyy-MM-dd"),"yyyy-MM-dd"));
